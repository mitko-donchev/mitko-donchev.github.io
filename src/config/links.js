...
export const GAME_SYNOPSIS = [
  "Some places don't let you leave. You wake at the edge of a village that shouldn't exist, and every road out only bends back to its gate. Wander the woods, the fields, the hollow caves beyond — walk far enough and you'll find its gate ahead of you again. The village remembers every attempt to leave, even the ones you'd rather forget.",
  "Explore a handcrafted overworld with fast, reactive combat and runs that reshape themselves each time you fall. Part action-RPG, part roguelike — every loop teaches you something the last one cost you.",
