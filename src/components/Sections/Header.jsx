  ...
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      <LeftSide className="flexCenter">
        <div>
          <h1 className="extraBold font60">Creating innovative mobile apps</h1>
          ...
          {/* <QuoteWrapper className="flexCenter darkBg radius8">
            ...
            <div>
              <p className="font15 whiteColor">
                <em>Working with Epic Millennium was a game-changer for our business. Their innovative solutions and seamless integration of technology ovecome our expectations.</em>
              </p>
              <p className="font13 orangeColor textRight" style={{ marginTop: '10px' }}>Rapido</p>
            </div>
          </QuoteWrapper> */}
          <DotsWrapper>
            <Dots />
